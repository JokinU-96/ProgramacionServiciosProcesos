...
//    private Socket cliente;
    ...
    public static void main(String[] args) {
        ...
        System.setProperty("javax.net.ssl.trustStore", "/home/149fa02@arriagainfo.local/Documentos/ProgramacionServiciosProcesos/ProgramacionSegura/UsuarioAlmacenSSLRSA");
    ...
    private void initClient() {
        ...
        try {
            ...
            cliente = (SSLSocket) sfact.createSocket("0.0.0.0", PUERTO);
